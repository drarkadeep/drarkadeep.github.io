...
### Easter eggs
Do not expand these, instead try to tinker with the website to find the easter eggs. > Not sure whether this will be implemented, but I have plans of creating three levels of easter eggs -
- Level 1 has EEs that can be found be tinkering rendered website elements
- Level 2 requires searching source code/this repo
- Level 3 will be completely obfuscated and nicely tucked away somewhere 👈(ﾟヮﾟ👈)

1. Change hero animation
    <details>
